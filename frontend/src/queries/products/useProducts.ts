...
export default function useProducts(searchQuery: string, sort: string, supplier: string, category: string, currentPage: number = 1, prioritizeLowStock: boolean = true) {
    return useQuery({
        ...
        queryFn: async ({ queryKey }) => {
            ...
            if (sortQuery) params.set("sortBy", sortQuery as string);
            ...
            params.set("prioritizeLowStock", prioritizeLowStock ? "true" : "false");
